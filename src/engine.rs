...
use http::{
    ...
    dominant_protocol_from_metrics, http_version_label, learn_http2_client_tuning,
    protocol_effective_add_threshold, protocol_family_for_version,
    protocol_growth_shield_min_samples, protocol_growth_shield_multiplier,
    protocol_prefetch_handshake_ms, protocol_reuse_thresholds,
...
pub(super) fn compute_refill_interval_ms(global_bandwidth_limit_bps: u64) -> u64 {
...
pub(super) fn compute_effective_connection_budget(
